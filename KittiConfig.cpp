...
std::string KittiConfig::data_directory = "../data_tracking_velodyne/testing/velodyne/";
std::string KittiConfig::raw_data_directory = "raw";
std::string KittiConfig::dataset_folder_template = "%|04|_sync";
std::string KittiConfig::point_cloud_directory = "../data_tracking_velodyne/testing/velodyne/0000/";
std::string KittiConfig::point_cloud_file_template = "%|060|.bin";
